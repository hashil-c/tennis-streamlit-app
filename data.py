...
games = [
    ...
    Game(datetime.datetime(2025, 10, 3), [SAH], 9, 1, [HAS]),
    Game(datetime.datetime(2025, 10, 8), [SAH, HAS], 3, 12, [MIS]),
    Game(datetime.datetime(2025, 10, 18), [HAS], 3, 1, [SAH]),
    Game(datetime.datetime(2025, 10, 30), [HAS], 1, 12, [MIS]),
    Game(datetime.datetime(2025, 11, 5), [HAS], 6, 3, [SAH]),
    Game(datetime.datetime(2025, 11, 13), [HAS], 6, 0, [BHA]),
    Game(datetime.datetime(2025, 11, 20), [HAS], 4, 1, [AKS]),
    Game(datetime.datetime(2025, 12, 11), [MIS], 12, 5, [HAS]),
    Game(datetime.datetime(2025, 12, 17), [HIT], 1, 8, [HAS]),
    ...
    Game(datetime.datetime(2026, 1, 23), [HAS], 6, 3, [HIT], type=GameType.HP),
    ...
    Game(datetime.datetime(2026, 2, 5), [AKS, HAS], 4, 5, [DEE, MIS]),
    Game(datetime.datetime(2026, 2, 5), [SAH, HAS], 6, 4, [AKS, MIS]),
    Game(datetime.datetime(2026, 2, 8), [HAS], 6, 3, [HIT]),
    ...
    Game(datetime.datetime(2026, 3, 17), [HAS], 3, 6, [AKS]),
    Game(datetime.datetime(2026, 3, 19), [HAS, MIS], 6, 3, [SAH]),
    Game(datetime.datetime(2026, 3, 19), [HAS], 1, 6, [MIS]),
    Game(datetime.datetime(2026, 3, 22), [HAS], 6, 4, [HIT], type=GameType.HP),
    Game(datetime.datetime(2026, 3, 25), [HAS], 6, 0, [HIT, MIS]),
    Game(datetime.datetime(2026, 3, 25), [HAS, MIS], 6, 0, [HIT]),
    Game(datetime.datetime(2026, 3, 25), [HAS, HIT], 2, 6, [MIS]),
    Game(datetime.datetime(2026, 3, 28), [HAS], 10, 3, [HIT]),
    Game(datetime.datetime(2026, 4, 2), [SAH], 6, 0, [HAS]),
    Game(datetime.datetime(2026, 4, 8), [AKS], 2, 6, [HAS]),
    Game(datetime.datetime(2026, 5, 6), [HAS], 8, 4, [HIT]),
    Game(datetime.datetime(2026, 5, 7), [HAS, ANJ], 0, 4, [SAH, MIS]),
    ...
    Game(datetime.datetime(2026, 6, 4), [HAS, SAH], 3, 6, [MIS, DEE], type=GameType.HP),
]
