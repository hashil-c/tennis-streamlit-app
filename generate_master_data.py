...
from calculator import Player, Game, Calculator, TableEntry, GameType
...
games = [
    ...
    Game(datetime.datetime(2024, 6, 20), [MIS, ANJ], 3, 6, [SAH, DEE]),
...
if __name__ == '__main__':
    ...
    table_entries = calculator.process_game(games=games)
    ...
    with open('master_data.json', 'w') as file:
        json.dump(df_data, file, indent=4)